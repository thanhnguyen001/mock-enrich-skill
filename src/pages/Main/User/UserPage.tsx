...
const UserPage: React.FC = () => {
  ...
  const getListNews = async () => {
    try {
      ...
      const postOfUser = data.filter((item) => item.nguoi_tao === user?.ten_nhan_vien);
      setPost(postOfUser);
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    <div className="user flex">
      <div className="user-info px-[8px] py-[8px] w-full">
        <div className="user-intro flex flex-col justify-center items-center">
          ...
          <div className="user-contact mt-16px">
            <div className="user-name text-tx-color">
              <p className="text-[20px] font-[500]">{user?.ten_nhan_vien}</p>
            </div>
            <div className="user-email flex items-center mr-16px text-tx-color">
              <MailOutlined />
              <p className="ml-8px">{user?.email}</p>
            </div>
            <div className="user-phone flex items-center text-tx-color">
              <PhoneOutlined />
        ...
        <div className="user-post mt-16px">
          {post.map((item, index) => (
